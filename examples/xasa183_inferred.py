#! /usr/bin/env python3
# types inferred by xp2f.py from asa183.py
# xp2f inference summary:
# function asa183_test:
#   return: kind=unknown rank=0
# function r8_random:
#   arg s1: kind=int rank=0
#   arg s2: kind=int rank=0
#   arg s3: kind=int rank=0
#   return tuple: out1: kind=real rank=0, out2: kind=real rank=0, out3: kind=real rank=0, out4: kind=real rank=0
# function r8_random_test01:
#   return: kind=unknown rank=0
# function r8_random_test02:
#   return: kind=unknown rank=0
# function r8_random_test03:
#   return: kind=unknown rank=0
# function r8_uni:
#   arg s1: kind=int rank=0
#   arg s2: kind=int rank=0
#   return tuple: out1: kind=real rank=0, out2: kind=real rank=0, out3: kind=real rank=0
# function r8_uni_test01:
#   return: kind=unknown rank=0
# function r8_uni_test02:
#   return: kind=unknown rank=0
# function r8_uni_test03:
#   return: kind=unknown rank=0
# function timestamp:
#   return: kind=unknown rank=0
#
