#! /usr/bin/env python3
# types inferred by xp2f.py from r8sm.py
# xp2f inference summary:
# function r8sm_test:
#   return: kind=unknown rank=0
# function i4_log_10:
#   arg i: kind=int rank=0
#   return: kind=int rank=0
# function r8ge_fa:
#   arg n: kind=int rank=0
#   arg a: kind=real rank=2
#   return tuple: out1: kind=real rank=2, out2: kind=int rank=1, out3: kind=int rank=0
# function r8ge_ml:
#   arg n: kind=int rank=0
#   arg a_lu: kind=real rank=2
#   arg pivot: kind=int rank=1
#   arg x: kind=real rank=1
#   arg job: kind=unknown rank=0
#   return: kind=real rank=1
# function r8ge_sl:
#   arg n: kind=int rank=0
#   arg a_lu: kind=real rank=2
#   arg pivot: kind=int rank=1
#   arg b: kind=real rank=1, kind=real rank=2
#   arg job: kind=int rank=0
#   return: kind=real rank=1
# function r8sm_indicator:
#   arg m: kind=int rank=0
#   arg n: kind=int rank=0
#   return tuple: out1: kind=real rank=2, out2: kind=real rank=1, out3: kind=real rank=1
# function r8sm_indicator_test:
#   return: kind=unknown rank=0
# function r8sm_ml:
#   arg n: kind=int rank=0
#   arg a_lu: kind=real rank=2
#   arg u: kind=real rank=1
#   arg v: kind=real rank=1
#   arg pivot: kind=int rank=1
#   arg x: kind=real rank=1
#   arg job: kind=unknown rank=0
#   return: kind=real rank=1
# function r8sm_ml_test:
#   return: kind=unknown rank=0
# function r8sm_mtv:
#   arg m: kind=int rank=0
#   arg n: kind=int rank=0
...
#   arg u: kind=real rank=1
#   arg v: kind=real rank=1
#   arg title: kind=char rank=0
#   return: kind=unknown rank=0
# function r8sm_print_test:
#   return: kind=unknown rank=0
# function r8sm_print_some:
#   arg m: kind=int rank=0
#   arg n: kind=int rank=0
#   arg a: kind=real rank=2
#   arg u: kind=real rank=1
#   arg v: kind=real rank=1
#   arg ilo: kind=int rank=0
#   arg jlo: kind=int rank=0
#   arg ihi: kind=int rank=0
#   arg jhi: kind=int rank=0
#   arg title: kind=char rank=0
#   return: kind=unknown rank=0
# function r8sm_print_some_test:
#   return: kind=unknown rank=0
# function r8sm_random:
#   arg m: kind=int rank=0
#   arg n: kind=int rank=0
#   return tuple: out1: kind=real rank=2, out2: kind=real rank=1, out3: kind=real rank=1
# function r8sm_random_test:
#   return: kind=unknown rank=0
# function r8sm_sl:
#   arg n: kind=int rank=0
#   arg a_lu: kind=real rank=2
#   arg u: kind=real rank=1
#   arg v: kind=real rank=1
#   arg b: kind=real rank=2
#   arg pivot: kind=int rank=1
#   arg job: kind=unknown rank=0
#   return: kind=real rank=1
# function r8sm_sl_test:
#   return: kind=unknown rank=0
# function r8sm_to_r8ge:
#   arg m: kind=int rank=0
#   arg n: kind=int rank=0
#   arg a: kind=real rank=2
#   arg u: kind=real rank=1
#   arg v: kind=real rank=1
#   return: kind=real rank=2
# function r8sm_to_r8ge_test:
#   return: kind=unknown rank=0
# function r8sm_zeros:
#   arg m: kind=int rank=0
#   arg n: kind=int rank=0
#   return tuple: out1: kind=real rank=2, out2: kind=real rank=1, out3: kind=real rank=1
# function r8sm_zeros_test:
#   return: kind=unknown rank=0
# function r8vec_indicator1:
#   arg n: kind=int rank=0
#   return: kind=real rank=1
# function r8vec_print:
#   arg n: kind=int rank=0
#   arg a: kind=real rank=1, kind=real rank=2
#   arg title: kind=char rank=0
#   return: kind=unknown rank=0
# function r8vec2_print_some:
#   arg n: kind=int rank=0
#   arg x1: kind=real rank=2
#   arg x2: kind=real rank=1
#   arg max_print: kind=int rank=0
#   arg title: kind=char rank=0
#   return: kind=unknown rank=0
# function timestamp:
#   return: kind=unknown rank=0
