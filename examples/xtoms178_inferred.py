#! /usr/bin/env python3
# types inferred by xp2f.py from toms178.py
# xp2f inference summary:
# function best_nearby:
#   arg delta: kind=real rank=1
#   arg point: kind=unknown rank=0
#   arg prevbest: kind=unknown rank=0
#   arg nvars: kind=int rank=0
#   arg f: kind=unknown rank=0
#   arg funevals: kind=int rank=0
#   return tuple: out1: kind=real rank=0, out2: kind=real rank=0, out3: kind=real rank=0
# function hooke:
#   arg nvars: kind=int rank=0
#   arg startpt: kind=real rank=1
#   arg rho: kind=real rank=0
#   arg eps: kind=real rank=0
#   arg itermax: kind=int rank=0
#   arg f: kind=unknown rank=0
#   return tuple: out1: kind=int rank=0, out2: kind=real rank=0
# function r8vec_print:
#   arg n: kind=int rank=0
#   arg a: kind=real rank=1
#   arg title: kind=char rank=0
#   return: kind=unknown rank=0
# function rosenbrock:
#   arg x: kind=real rank=1
#   arg n: kind=int rank=0
#   return: kind=real rank=0
