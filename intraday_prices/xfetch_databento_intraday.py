...
# script's job is a live network call to the Databento API (via the
# `databento` package) -- there is no numeric computation here for a Fortran
# transpiler to translate; the whole file is API-key handling, HTTP-backed
# fetching, and directory layout. Left as an unmodified copy of the original.
"""
