...
# script's job is a live network call to Yahoo Finance (via `yfinance`) --
# there is no numeric computation here for a Fortran transpiler to
# translate; the whole file is HTTP-backed fetching and directory layout.
