!*****************************************************************************************
! Vendored, unmodified, into xp2f.py as the Fortran backend for scipy.optimize.fsolve
! (and, in future, least_squares). Source: https://github.com/fortran-lang/minpack
! (BSD-style license), a merge of Jacob Williams' "modernized minpack" project into the
! fortran-lang community. See that project's authorship/license notes below and at the
! source URL above.
!*****************************************************************************************
!>
!  Modernized Minpack
