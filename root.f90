! Vendored from https://github.com/jacobwilliams/roots-fortran
! (Jacob Williams, BSD-3-Clause license). Full upstream module kept intact;
! xp2f.py's scipy.optimize.brentq support only uses the root_scalar('brentq', ...)
! functional wrapper (a direct port of scipy's brentq.c) but the whole file
! is vendored as-is per upstream distribution.
!*****************************************************************************************
!>
